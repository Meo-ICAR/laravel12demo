...
class ImportOnlyProvvigioni extends Command
{
    protected $signature = 'provvigioni:import-only
    ...
    public function handle()
    {
        ...
        */
        ...
        $this->info("Importing only provvigioni from {$startDate->format('Y-m-d')} to {$endDate->format('Y-m-d')}");
