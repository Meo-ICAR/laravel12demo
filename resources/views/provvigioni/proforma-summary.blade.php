                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('provvigioni.createProformaFromSummary') }}" method="POST" style="display:inline;">
                                        ...
                                        <button type="submit" class="btn btn-sm btn-success" @if(empty($item->email) || $item->totale == 0 || $item->totale < 50) disabled @endif
                                            @if($item->totale < 50) title="Minimum amount of €50 required" @endif>
