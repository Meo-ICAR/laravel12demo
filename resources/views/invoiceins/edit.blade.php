        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-edit mr-2"></i>Edit Invoicein
                    </h3>
                ...
                <div class="card-body">
                    <form action="{{ route('invoiceins.update', $invoicein->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nome_fornitore') is-invalid @enderror"
                                           id="nome_fornitore" name="nome_fornitore"
                                           value="{{ old('nome_fornitore', $invoicein->nome_fornitore) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('partita_iva') is-invalid @enderror"
                                           ...
                                           value="{{ old('partita_iva', $invoicein->partita_iva) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('tipo_di_documento') is-invalid @enderror"
                                        ...
                                        <option value="Fattura" {{ old('tipo_di_documento', $invoicein->tipo_di_documento) == 'Fattura' ? 'selected' : '' }}>Fattura</option>
                                        <option value="Nota di Credito" {{ old('tipo_di_documento', $invoicein->tipo_di_documento) == 'Nota di Credito' ? 'selected' : '' }}>Nota di Credito</option>
                                        <option value="Nota di Debito" {{ old('tipo_di_documento', $invoicein->tipo_di_documento) == 'Nota di Debito' ? 'selected' : '' }}>Nota di Debito</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nr_documento') is-invalid @enderror"
                                           id="nr_documento" name="nr_documento"
                                           value="{{ old('nr_documento', $invoicein->nr_documento) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('data_documento') is-invalid @enderror"
                                           ...
                                           value="{{ old('data_documento', $invoicein->data_documento) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('importo') is-invalid @enderror"
                                           ...
                                           value="{{ old('importo', $invoicein->importo) }}"
                                           placeholder="0.00">
                                    @error('importo')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Update Invoicein
                            </button>
                            <a href="{{ route('invoiceins.index') }}" class="btn btn-secondary">
